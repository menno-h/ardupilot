...
const AP_Param::Info var_info[] PROGMEM = {
    ...
    // @Param: THR_IN_DEADBAND
    // @DisplayName: Throttle deadband
    // @Description: The throttle deadband
    // @User: Standard
    // @Range: 0 300
    // @Units: Percent*10
    // @Increment: 1
    GSCALAR(thr_in_deadband,        "THR_IN_DEADBAND",    DEFAULT_THR_IN_DEADBAND), // adding of this parameter so that throttle_in_deadband used for throttle_hold can be changed in MP (23/03/2014-Menno)

    // @Param: FLTMODE1
    // @DisplayName: Flight Mode 1
    // @Description: Flight mode when Channel 5 pwm is <= 1230
    // @Values: 0:Stabilize,1:Acro,2:AltHold,3:Auto,4:Guided,5:Loiter,6:RTL,7:Circle,8:Position,9:Land,10:OF_Loiter,11:Drift,13:Sport,14:Cruise,15:Stable_quat // (26/02/2014-Menno)
    // @User: Standard
    ...
    // @Increment: 1
    // @User: Standard
    GSCALAR(roll_limit_cd,          "LIM_ROLL_CD",    HEAD_MAX_CENTIDEGREE), // (04/08/2014-Menno)
    
    // @Group: ARMING_
    // @Path: ../libraries/AP_Arming/AP_Arming.cpp
    GOBJECT(arming,                 "ARMING_", AP_Arming), // (04/08/2014-Menno)
    ...
    // @Increment: 1
    // @User: Standard
    ASCALAR(pitch_limit_max_cd,     "LIM_PITCH_MAX",  PITCH_MAX_CENTIDEGREE), // (04/08/2014-Menno)
    ...
    // @Increment: 1
    // @User: Standard
    ASCALAR(pitch_limit_min_cd,     "LIM_PITCH_MIN",  PITCH_MIN_CENTIDEGREE), // (04/08/2014-Menno)
    ...
    // @Increment: 1
    // @User: Standard
    ASCALAR(airspeed_min, "ARSPD_FBW_MIN",  AIRSPEED_FBW_MIN), // (04/08/2014-Menno)
    ...
    // @Increment: 1
    // @User: Standard
    ASCALAR(airspeed_max, "ARSPD_FBW_MAX",  AIRSPEED_FBW_MAX), // (04/08/2014-Menno)
    ...
    // @Units: cm/s
    // @User: User
    GSCALAR(airspeed_cruise_cm,     "TRIM_ARSPD_CM",  AIRSPEED_CRUISE_CM), // (05/08/2014-Menno)
...
//    GGROUP(pid_throttle_alt_cruise, "THR_ALT_CRUISE_", AC_PID), // (04/03/2014-Menno)
    ...
    GOBJECT(airspeed,                               "ARSPD_",   AP_Airspeed), // (05/08/2014-Menno)
