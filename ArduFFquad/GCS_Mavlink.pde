...
static NOINLINE void send_extended_status1(mavlink_channel_t chan, uint16_t packet_drops)
{
    ...
    if (airspeed.enabled()) { // (05/08/2014-Menno)
    ...
    if (airspeed.enabled() && airspeed.use()) { // (05/08/2014-Menno)
    ...
    if (airspeed.healthy()) {
        control_sensors_health |= MAV_SYS_STATUS_SENSOR_DIFFERENTIAL_PRESSURE; // (05/08/2014-Menno)
    }
...
//static void NOINLINE send_user_variables(mavlink_channel_t chan) // (18/03/2014-Menno)
//{
//    mavlink_msg_nav_controller_output_send(
//        chan,
//        control_roll,
...
//// User variables series 2 (8 variables) - not working yet :( // (23/03/2014-Menno)
//static void NOINLINE send_named_value_float(mavlink_channel_t chan)
//{
//    mavlink_msg_named_value_float(    
//        chan,
//        control_pitch,
//        control_pitch,
//        control_pitch,
...
//#if HIL_MODE != HIL_MODE_DISABLED // original (19/03/2014-Menno)
...
// User variables series 1 (4 variables can be written to mission planner here (19/03/2014-Menno)
//#if HIL_MODE == HIL_MODE_DISABLED
static void NOINLINE send_servo_out(mavlink_channel_t chan)
{
...
{
    float aspeed; // from here (05/08/2014-Menno)
    if (airspeed.enabled()) {
        aspeed = airspeed.get_airspeed();
    } else if (!ahrs.airspeed_estimate(&aspeed)) {
    } // to here (05/08/2014-Menno)
    mavlink_msg_vfr_hud_send(
        chan,
        aspeed, // added line (05/08/2014-Menno)
        // (float)g_gps->ground_speed_cm / 100.0f, // original line
...
//    case MSG_NAMED_VALUE_FLOAT:    // (23/03/2014-Menno)
//        CHECK_PAYLOAD_SIZE(NAMED_VALUE_FLOAT);
//        send_named_value_float(chan);
//        break;

    case MSG_SERVO_OUT: 
//#if HIL_MODE != HIL_MODE_DISABLED // (20/03/2014-Menno) // commented out to always send
...
GCS_MAVLINK::data_stream_send(void)
{
    ...
    if (stream_trigger(STREAM_RC_CHANNELS)) {
        ...
        send_message(MSG_USER_VARIABLES); // (19/03/2014-Menno)
...
//    if(stream_trigger(NAMED_VALUE_FLOAT)) {  // (24/03/2014-Menno)
//        send_message(NAMED_VALUE_FLOAT);
//    }
}
...
void GCS_MAVLINK::handleMessage(mavlink_message_t* msg)
{
    ...
    case MAVLINK_MSG_ID_REQUEST_DATA_STREAM:
    {
        ...
        case MAV_DATA_STREAM_EXTRA3:
            ...
            break;
//       case MAV_DATA_NAMED_VALUE_FLOAT:              // (24/03/2014-Menno) // user variables series 2 (8 variables)
//            streamRates[NAMED_VALUE_FLOAT].set(freq);
//            break;
        ...
        case MAV_CMD_PREFLIGHT_CALIBRATION:
            ...
            } else if (packet.param3 == 1) {  // from here (05/08/2014-Menno)
              if (airspeed.enabled()) {      
                    zero_airspeed();
              }                              
            }                                // to here (05/08/2014-Menno)
...
mission_failed:
    ...
    case MAVLINK_MSG_ID_RC_CHANNELS_OVERRIDE: // (19/03/2014-Menno) This is edited!!! for original, check original files, This does not work!
    {
        ...
        v[0] = control_roll; // user variables
        v[1] = control_roll/10;
        v[2] = control_roll/100;
        v[3] = control_roll/1000;
        v[4] = control_roll/10000;
        v[5] = control_roll/100000;
        v[6] = control_roll*10;
        v[7] = control_roll*100;
    ...
    case MAVLINK_MSG_ID_HIL_STATE:
    {
        ...
        airspeed.disable(); // (05/08/2014-Menno)
...
//send airspeed calibration data // (05/08/2014-Menno)
