...
#include <AP_Arming.h>          // (04/08/2014-Menno)
#if SPRAYER == ENABLED
...
// key aircraft parameters passed to multiple libraries // (01/08/2014-Menno)
...
static bool in_log_download; // (04/08/2014-Menno)
...
///////////////////////////////////////////////////////////////////////
static int32_t desired_yaw_rate_quaternion; // (20/03/2014-Menno) // seperate target rate used in quaternion control
...
////////////////////////////////////////////////////////////////////////////////
// Airspeed Sensors (01/08/2014-Menno)
////////////////////////////////////////////////////////////////////////////////
...
static bool home_is_set; // (04/08/2014-Menno)
...
////////////////////////////////////////////////////////////////////////////////
static AP_Arming arming(ahrs, barometer, home_is_set, gcs_send_text_P); // (04/08/2014-Menno)
...
#endif
#ifdef USERHOOK_2HZLOOP
    { userhook_2Hz, 50,   1000 },
#endif
#ifdef USERHOOK_20HZLOOP
    { userhook_20Hz, 5,   1200 },
#endif
};
...
//    menno4 = desired_yaw_rate_quaternion; // centidegrees/s //TODO: uncomment
    ...
    if (control_mode == STABLE_QUAT || control_mode == CRUISE ){ // (11/03/2014-Menno)
      ...
      // now convert the desired rotations to a quaternion:
      update_quaternion();
    }
...
static void read_airspeed(void) // (01/08/2014-Menno) // Originally (in AP:Plane) this is in sensors.pde
{
    if (airspeed.enabled()) {
        airspeed.read();
...
bool set_yaw_mode(uint8_t new_yaw_mode)
{
	...
	case YAW_CRUISE:  // (26/02/2014-Menno)
            // Put initialisation here when entering YAW_CRUISE
            yaw_initialised = true;
            break;
        case YAW_STABLE_QUAT: // (11/03/2014-Menno)
            // Put initialisation here when entering YAW_STABLE_QUAT
            yaw_initialised = true;
            break;
...
bool set_roll_pitch_mode(uint8_t new_roll_pitch_mode)
{
    ...
    switch( new_roll_pitch_mode ) {
        ...
        case ROLL_PITCH_SPORT:
            roll_pitch_initialised = true;
            break;
        case ROLL_PITCH_CRUISE:  // (26/02/2014-Menno)
            // Write initialisations to performed here
            reset_roll_pitch_in_filters(g.rc_1.control_in, g.rc_2.control_in);
            roll_pitch_initialised = true;
            break;
...
// update_roll_pitch_mode - run high level roll and pitch controllers - decoding of pilot's input and calls to new attitude control functions
// 100hz update rate
...
bool set_throttle_mode( uint8_t new_throttle_mode )
{
	...
	case THROTTLE_CRUISE:  // (26/02/2014-Menno)
            // add initialisation: altitude_error=0, ....      
            // indicate we can enter this mode successfully
            throttle_initialised = true;
            break;
            
        case THROTTLE_STABLE_QUAT: // (11/03/2014-Menno)
            // add initialisation: altitude_error=0, ....      
            // indicate we can enter this mode successfully
            throttle_initialised = true;
            break;
