...
public:
    ...
    enum {
        ...
        k_param_rcmap,
        k_param_thr_in_deadband, // (23/03/2014-Menno)
        ...
        // AP:Plane Parameters (04/08/2014-Menno)
    ...
    AP_Int16        thr_in_deadband;        // (26/03/2014-Menno)
    ...
    // Navigational maneuvering limits // (04/08/2014-Menno)
    //
    ...
    AP_Int32        airspeed_cruise_cm; // (05/08/2014-Menno)
